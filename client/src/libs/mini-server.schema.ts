...
export interface paths {
        ...
        get: {
            ...
            responses: {
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["ProjectVersionListResponse"];
                    };
                };
            };
        };
    ...
    "/api/projects/{project_id}/release": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["ReleaseVersionRequest"];
                };
            };
            responses: {
                200: {
    ...
    "/api/projects/{project_id}/convert": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["ConvertToAppRequest"];
                };
            };
            responses: {
                200: {
    ...
    "/api/apps/{app_id}/source": {
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["UpdateAppSourceCodeRequest"];
                };
            };
            responses: {
                200: {
...
export interface components {
    schemas: {
        ...
        AppListResponse: {
            ...
            links: components["schemas"]["AppListLinks"];
            meta: components["schemas"]["AppListMeta"];
        };
        AppResponse: {
            data: components["schemas"]["App"];
            links: components["schemas"]["AppResponseLinks"];
        };
        AppResponseLinks: {
            self: string;
        };
        ...
        DashboardLayoutResponse: {
            data: components["schemas"]["DashboardLayout"];
            links: components["schemas"]["DashboardLayoutResponseLinks"];
        };
        DashboardLayoutResponseLinks: {
            self: string;
        };
        DashboardWidget: {
            /** Format: int32 */
        ...
        Project: {
            ...
            /** Format: date-time */
            updated_at: string;
            versions?: components["schemas"]["ProjectVersion"][] | null;
        };
        ProjectListLinks: {
            collection: string;
            self: string;
        ...
        ProjectListResponse: {
            ...
            links: components["schemas"]["ProjectListLinks"];
            meta: components["schemas"]["ProjectListMeta"];
        };
        ProjectResponse: {
            data: components["schemas"]["Project"];
            links: components["schemas"]["ProjectResponseLinks"];
        };
        ProjectResponseLinks: {
            self: string;
        ...
        ProjectVersionListLinks: {
            project: string;
            self: string;
        };
        ProjectVersionListMeta: {
            /** Format: int64 */
            count: number;
            project_id: string;
        };
        ProjectVersionListResponse: {
            data: components["schemas"]["ProjectVersion"][];
            links: components["schemas"]["ProjectVersionListLinks"];
            meta: components["schemas"]["ProjectVersionListMeta"];
        };
        ProjectVersionResponse: {
            data: components["schemas"]["ProjectVersion"];
            links: components["schemas"]["ProjectVersionResponseLinks"];
        };
        ProjectVersionResponseLinks: {
            project: string;
            self: string;
        };
        QueryRequest: {
